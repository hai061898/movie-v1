...
import 'package:movie/bloc/movie_detail_bloc/movie_detail_cubit.dart';
import 'package:movie/data/services/movie_service.dart';
import 'package:movie/ui/screens/details/components/similar_movies.dart';
import 'package:shimmer/shimmer.dart';
import 'package:transparent_image/transparent_image.dart';

import 'casts_load.dart';
    ...
    return Scaffold(
      body: BlocProvider(
        create: (_) => MovieDetailCubit(
          repository: context.read<MovieService>(),
        )..fetchMovie(movieId),
        child: DetailView(
          movieId: movieId,
